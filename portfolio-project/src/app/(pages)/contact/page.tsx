    ...
    return (
        <div className="m-20">
            <div>
                ...
                <div className="flex flex-col justify-center mt-10 border border-gray-700 w-auto">
                    ...
                    <div className="m-15 flex flex-row gap-20 justify-center items-center w-auto">
                        <div className="flex flex-col w-full">
                            <label className="whitespace-nowrap w-full">First Name:</label>
                            <input className="input mt-auto" />
                        </div>
                        <div className="flex flex-col w-full">
                            <label className="whitespace-nowrap w-full">Last Name:</label>
                            <input className="input mt-auto" />
                        </div>
                    </div>
                </div>
