        ...
        <div className='sticky bg-stone-700 shadow-xl top-0 w-full z-50 pt-3 pb-2 px-7'>
            <div className='hidden md:grid md:grid-cols-3 px-15'>
                ...
                <nav className='justify-self-end col-span-2'>
                    <ul className='md:flex md:flex-row md:gap-5 lg:gap-10'>
            ...
            <nav className={`md:hidden overflow-hidden transition-all duration-300 ${isMenuOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
